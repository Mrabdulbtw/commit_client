  ...
  return (
    <div className="max-w-full">
      <div className="flex items-center">
        ...
        />
        <div className="px-4 py-2 text-blue-600">{filename}</div>
      </div>

      {open && (
        <div
          className={cn(
            "border border-gray-300 shadow max-w-full!  bg-white shadow-gray-100 p-1 rounded",
          ...
          {lines?.slice(1).map((line, index) => {
            ...
            return (
              ...
              >
                ...
                <pre className="px-2 text-sm text-[#394246]  whitespace-pre-line">
                  {line}
                </pre>
              </div>
            );
